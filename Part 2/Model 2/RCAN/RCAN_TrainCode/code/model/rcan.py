...
class Self_Attn(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.out_dim = 4     # Reduction = 16
        self.snconv1x1_theta = nn.Conv2d(in_channels=in_channels, out_channels=self.out_dim, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, x):
        ...
        phi = phi.view(bs, self.out_dim, h*w)
        # Attn map
